...
// pid(float P, float I, float D, float IMax, float PIDMax, uint16_t I_Time = 1, uint16_t D_Time = 1, uint16_t I_Limited = 9999); //传统pid构造函数
    ...
    : PitchSpeed(-6, 0, -8, 0, 0, 10, 10, 500), 
	  PitchPosition(-30, -1, 0, 3001, 0, 10, 10, 200),//(15, 1, 0, 1800, 10000, 10, 10, 120)(-15, -3, -40, 1500, 10000, 10, 10, 80)	(-20, -8, 0, 1200, 10000, 10, 10, 80)
      PitchGyroSpeed(-8, 0, 0, 0, 10, 10, 500),
      PitchGyroPosition(300, 30, 0, 2011, 0, 10, 10, 5),
	  
	  Pitch2ndSpeed(-6, 0, -8, 0, 0, 10, 10, 500),
	  Pitch2ndPosition(-30, -1, 0, 1802, 0, 10, 10, 120),

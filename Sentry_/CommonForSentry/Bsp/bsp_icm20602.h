...
*         v1.0 创建此文件
*/
#ifndef __BSP_ICM20602_H
#define __BSP_ICM20602_H
...
uint8_t bsp_icm20602_ReadReg(uint8_t regAddr);//提供给姿态解算的读数据函数
void bsp_icm20602_ReadRegs(uint8_t regAddr,uint8_t *pBuff,uint8_t length);//标准SPI读函数
HAL_StatusTypeDef bsp_icm20602_Init(void);//ICM20602初始化
